...
#SBATCH -J sfno_linear_74chq_sc3_layers8_edim384_dt6h_wstgl2
#SBATCH --image=amahesh19/modulus-makani:0.1.0-torch_patch-23.11-multicheckpoint
#SBATCH --module=gpu,nccl-2.18                                          
#SBATCH -o logs/sfno_linear_74chq_sc3_layers8_edim384_dt6h_wstgl2-%j.out
#SBATCH --mail-type=begin,end,fail                                      
#SBATCH --mail-user=amahesh@lbl.gov 
#SBATCH --array 0-29

export config_file=./config/sfnonet.yaml
export config='sfno_linear_74chq_sc3_layers8_edim384_dt6h_wstgl2'
